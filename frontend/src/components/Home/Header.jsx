        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">Sri Eshwar College of Engineerig</p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <a href="/student-dashboard" className="text-gray-600 hover:text-gray-900 transition-colors">Dashboard</a>
